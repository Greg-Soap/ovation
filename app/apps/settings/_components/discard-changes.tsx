    ...
    <div className='flex flex-col items-center bg-[#232227] gap-9 p-9 rounded-[24px]'>
      <div className='flex flex-col items-center gap-[33px]'>
        <div className='flex items-center bg-[#333726] rounded-full p-2'>
          <Image src='/assets/images/settings/save-01.png' alt='Save' width={27} height={27} />
        </div>

        <div className='flex flex-col items-center gap-2.5 text-center'>
          <h2 className='text-[#F8F8FF] font-semibold'>Unsaved changes</h2>
          <p className='text-[#B3B3B3] text-xs max-w-[300px]'>
            If you choose to cancel without saving, your changes will not be retained. Make sure to
            save any changes before exiting the window.
          </p>
        </div>
      </div>
