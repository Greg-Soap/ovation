            ...
            <Tabs defaultValue='All' className='w-full flex flex-col gap-10'>
              ...
              <TabsContent value='All'>
                <div className='flex flex-wrap gap-4'>
                  {items.map((item, index) => (
                    <div
                      className='w-full lg:w-[296px] flex flex-col bg-[#18181C] border border-[#FFFFFF14] rounded-[10px] relative'
                      key={index}>
                      ...
                      <div className='flex flex-col items-center justify-between bg-[#111115] border border-[#FFFFFF0D] px-3 py-3 rounded-b-[10px] gap-3'>
                        <div className='flex items-center justify-between w-full'>
                          <div className='flex flex-col items-start'>
                            <p className='text-[11px] text-white'>{item.artist}</p>
              ...
              <TabsContent value='Complete'>
                <div className='flex flex-wrap gap-4'>
                  {items.map((item, index) => (
                    <div
                      className={`${item.isComplete ? 'flex' : 'hidden'} w-full lg:w-[296px] flex-col bg-[#18181C] border border-[#FFFFFF14] rounded-[10px] relative`}
                      key={index}>
                      <div className='flex items-center p-2 rounded-full bg-[#333726] absolute right-5 top-3'>
                        <LikeIcon
                          className={`w-4 h-4 transition-all duration-300 ${item.isLiked ? 'stroke-none fill-[#CFF073]' : 'stroke-[#CFF073] fill-none'}`}
              ...
              <TabsContent value='Domain'>
                <div className='flex flex-wrap gap-4'>
                  {items.map((item, index) => (
                    <div
                      className={`${item.isDomain ? 'flex' : 'hidden'} w-full lg:w-[296px] flex-col bg-[#18181C] border border-[#FFFFFF14] rounded-[10px] relative`}
                      key={index}>
                      <div className='flex items-center p-2 rounded-full bg-[#333726] absolute right-5 top-3'>
                        <LikeIcon
                          className={`w-4 h-4 transition-all duration-300 ${item.isLiked ? 'stroke-none fill-[#CFF073]' : 'stroke-[#CFF073] fill-none'}`}
              ...
              <TabsContent value='Collectibles'>
                <div className='flex flex-wrap gap-4'>
                  {items.map((item, index) => (
                    <div
                      className={`${item.isCollectible ? 'flex' : 'hidden'} w-full lg:w-[296px] flex-col bg-[#18181C] border border-[#FFFFFF14] rounded-[10px] relative`}
                      key={index}>
                      <div className='flex items-center p-2 rounded-full bg-[#333726] absolute right-5 top-3'>
                        <LikeIcon
                          className={`w-4 h-4 transition-all duration-300 ${item.isLiked ? 'stroke-none fill-[#CFF073]' : 'stroke-[#CFF073] fill-none'}`}
              ...
              <TabsContent value='Metaverse'>
                <div className='flex flex-wrap gap-4'>
                  {items.map((item, index) => (
                    <div
                      className={`${item.isMetaverse ? 'flex' : 'hidden'} w-full lg:w-[296px] flex-col bg-[#18181C] border border-[#FFFFFF14] rounded-[10px] relative`}
                      key={index}>
                      <div className='flex items-center p-2 rounded-full bg-[#333726] absolute right-5 top-3'>
                        <LikeIcon
                          className={`w-4 h-4 transition-all duration-300 ${item.isLiked ? 'stroke-none fill-[#CFF073]' : 'stroke-[#CFF073] fill-none'}`}
              ...
              <TabsContent value='Art'>
                <div className='flex flex-wrap gap-4'>
                  {items.map((item, index) => (
                    <div
                      className={`${item.isArt ? 'flex' : 'hidden'} w-full lg:w-[296px] flex-col bg-[#18181C] border border-[#FFFFFF14] rounded-[10px] relative`}
                      key={index}>
                      <div className='flex items-center p-2 rounded-full bg-[#333726] absolute right-5 top-3'>
                        <LikeIcon
                          className={`w-4 h-4 transition-all duration-300 ${item.isLiked ? 'stroke-none fill-[#CFF073]' : 'stroke-[#CFF073] fill-none'}`}
