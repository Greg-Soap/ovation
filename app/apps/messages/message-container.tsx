      ...
      <section
        ...
        <div className='flex flex-col items-center gap-[13px]'>
          <div className='flex flex-col items-center gap-[6px]'>
            <p className='text-[#F8F8FF] text-xl font-semibold'>Select Message</p>
  ...
  return (
    <section
      ...
      <div className='flex lg:hidden bg-[rgba(17,17,21,0.8)] items-center gap-4 w-full p-5 absolute top-0'>
        ...
        <p className='text-sm font-medium text-[#F8F8FF]'>{friend.displayName}</p>
      </div>
      ...
      <div className='w-full border-b border-[#1A1A1A] py-9 flex flex-col items-center gap-4 h-fit mt-0 lg:mt-[250px]'>
        ...
        <p className='text-xs text-[#E6E6E6] text-center max-w-[70%]'>{friend.biography}</p>

        <div className='flex items-center gap-6'>
          <p className='flex items-center gap-[9px] text-sm text-[#E6E6E6] font-semibold'>
            {friend.followingCount} <span className='text-[#808080] font-medium'>Following</span>
          </p>
