...
export default function MessageContainer({
  ...
  if (!friend) {
    return (
      <ErrorBoundary FallbackComponent={ErrorFallback}>
        <section className="w-full h-[100vh] lg:h-full lg:col-span-2 flex flex-col items-center justify-center bg-primaryBg other-link overflow-auto">
          <div className="flex flex-col items-center gap-[13px]">
            <div className="flex flex-col items-center gap-[6px]">
              <p className="text-white100 text-xl font-semibold">
                No Conversation Selected
              </p>
              <p className="text-white90 text-center text-sm max-w-[280px]">
  ...
  return (
    <ErrorBoundary FallbackComponent={ErrorFallback}>
      <section className="w-full h-[100vh] lg:h-full lg:col-span-2 flex flex-col bg-primaryBg other-link overflow-scroll">
        <ErrorBoundary FallbackComponent={ErrorFallback}>
        ...
        <ErrorBoundary FallbackComponent={ErrorFallback}>
          <div className="w-full border-b border-sectionBorder py-9 flex flex-col items-center gap-4 h-fit">
            <Image
              src={
          ...
          <div className="flex-grow overflow-y-auto px-3 pt-[30px] pb-[100px] md:px-[30px] md:pt-[30px] md:pb-[90px] xir:p-[30px]">
            {loading ? (
              <div className="flex justify-center items-center h-full">
                <p className="text-white100">Loading messages...</p>
              </div>
            ) : (
              messages.map((msg, index) => (
                ...
                >
                  <p
                    className={`px-5 py-[10px] rounded-[20px] text-white100 text-sm font-medium max-w-[85%] lg:max-w-[50%] ${
        ...
        <ErrorBoundary FallbackComponent={ErrorFallback}>
          <div className="w-full p-5 border-t border-sectionBorder sticky bottom-0 bg-primaryBg">
            <div className="w-full flex items-center bg-popBg rounded-[500px] p-2 h-[50px]">
              <div className="flex">
              ...
              <Input
                ...
                value={message}
                className="h-[24px] text-white100 bg-transparent border-none  outline-none ring-0 focus:outline-none focus-visible:border-none ml-0 py-"
