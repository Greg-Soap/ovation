...
const NftCard: FC<NftCardProps> = ({ type, imgSrc, artist, price, className }: any) => {
  return (
    <div className={`w-full ${className}  flex flex-col border border-[#FFFFFF14] rounded-[10px]`}>
      <Image src={imgSrc} alt='NFT Preview' width={500} height={217} className='rounded-t-[10px]' />
