    ...
    <div className='w-full flex flex-col gap-10'>
      ...
      <div className='p-4 items-center w-full rounded-lg flex flex-col gap-10 border-[#353538] border-[1px]'>
        ...
        <div id='top-3 section' className='w-full flex flex-col gap-10'>
          <div
            ...
            <div className='flex w-[90%] text-white py-5 px-4 bg-[#1A1A1A] rounded-[18px] mb-10 items-center justify-between border border-[#FFFFFF4D]'>
              <div className='flex items-center gap-2'>
                ...
                <div className='flex flex-col'>
                  <p className='2xl:text-xl text-sm font-semibold'>{filteredData[0].displayName}</p>
          ...
          <div id='runner-up' className='lg:flex-row flex flex-col gap-2 justify-between'>
            <div
              id='2'
      ...
      <div
        ...
        <div className='flex flex-col w-full gap-4'>
          ...
          <p className='text-sm text-[#B3B3B3]'>
            Passionate NFT holder exploring the future of digital ownership. Join me in discovering
            the limitless possibilities of the NFT ecosystem. #NFTCommunity
          </p>
        </div>
      </div>
