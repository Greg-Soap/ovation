          ...
          >
            <div className="flex items-start lg:items-center gap-4 flex-col lg:flex-row">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-xs text-white60">{task.description}</p>
              </div>
            </div>
            <Button
              asChild
            ...
            >
              <Link
                href={task.link}
                className="text-[10px] text-primaryBg font-medium"
              >
                {task.buttonText}
              </Link>
            </Button>
...
function DiscoverFeature(user: FeaturedUser) {
  return (
    <div className="border border-white08 rounded-[14px] p-6 gap-9 flex flex-col">
      <div className="flex items-center w-full justify-between">
        <p className="text-base font-medium text-white100">FEATURED</p>
        {/* <Button className='bg-white text-buttonTextColor font-semibold border-none outline-none px-4 py-[10px] rounded-[400px] w-fit h-fit text-xs transition-all duration-300 hover:opacity-80'>
          View all
        </Button> */}
      </div>
      <div
      ...
      >
        ...
        <div className="flex flex-col max-w-[372px] gap-4">
          <div className="flex items-center w-full justify-between pb-6 border-b border-white05">
            ...
            <Button className="bg-button px-2 py-[6px] border-none outline-none font-medium w-fit h-fit text-buttonTextColor text-[9.6px] transition-all duration-300 hover:opacity-80">
              Follow
            </Button>
          </div>
          <p className="text-sm text-white70 pb-6 border-b border-white05">
            {user.desc}
          </p>
          <div className="flex w-full gap-2">
            {[
              ...
              <p
                key={index}
                className="rounded-full border-[1px] text-[10px] py-1 px-2 text-white bg-secondaryBg border-[#353538]"
              >
    ...
    if (data.length === 0) {
      return (
        <div className="flex flex-col items-center justify-center h-[400px] text-center">
          <p className="text-lg font-semibold text-white100 mb-2">
...
const CTabTrigger = ({
  ...
  return (
    <TabsTrigger
      value={value}
      className="text-[10px] font-normal p-2 px-4 rounded-full border-none bg-popBg  text-white60 data-[state=active]:bg-white100 data-[state=active]:text-popBg"
    >
      {children}
    </TabsTrigger>
  )
