  ...
  return (
    <div className='flex flex-col gap-5 items-center my-[60px] w-full lg:w-[45%]'>
      ...
      <p className='text-[#999999] text-center'>
        Your response has been recorded, we will notify you when we go live, in the mean time follow
      ...
      <div className='flex lg:flex-row flex-col items-center gap-5 w-fit'>
        <Link
          ...
          <Button asChild className='bg-[#CFF073] text-sm text-[#0B0A10] h-fit gap-2'>
            <PulseButton pulseColor='#CFF073'>
              <img src='/assets/images/twitter-LP.png' alt='Twitter Logo' className='w-4 h-3' />
        ...
        <Link
          ...
          <Button asChild className='bg-[#CFF073] text-sm text-[#0B0A10] h-fit gap-2'>
            <PulseButton pulseColor='#CFF073'>
              <img src='/assets/images/linkedIn-LP.png' alt='LinkedIn Logo' className='w-4 h-4' />
