...
export default function Features() {
  return (
    <section className="container flex flex-col items-center gap-10 py-8 md:gap-20 md:py-16 mt-24 md:mt-20">
      <div>
        <h2 className="text-center font-bold font-heading  text-[26px] leading-[32px]  md:text-[40px] md:leading-[50px]">
          All your NFTs - One Powerful Platform
        </h2>
        <p className="text-center font-light text-lighter text-base md:text-2xl tracking-[-0.87px] mt-2 ">
      ...
      <div className="flex justify-between items-center flex-wrap gap-6  md:gap-12 ">
        {features.map((feature) => (
          ...
          >
            ...
            />
            <h6 className="text-lg md:text-2xl text-center  font-bold font-heading mb-2">
              {feature.title}
            </h6>
            <p className="text-sm md:text-xl text-center text-lighter font-light">
              {feature.description}
            </p>
          </div>
        ))}
